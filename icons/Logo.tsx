  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 64 64" fill="none">
      ...
      <G transform="translate(24.3, 14.95)">
        <Ellipse cx="11.75" cy="9.5" rx="11.75" ry="9.5" stroke="white" strokeWidth={2} fill="none" />
        ...
        <Path d="M5.875 2.5c1 1 1 12 0 14" stroke="white" strokeWidth={2} strokeLinecap="round" fill="none" />
        <Path d="M17.625 2.5c-1 1-1 12 0 14" stroke="white" strokeWidth={2} strokeLinecap="round" fill="none" />
      </G>
    </Svg>
  );
}
